...
paths:
  ...
  /RCR_HHANDLER/ROWS/{row_start}:{row_end}/{output}:
    get:
      ...
      x-api-path-slug: rcr-hhandlerrowsrow-startrow-endoutput-get
      parameters:
      - in: path
        name: output
        description: which format to output (JSON,XML,CSV,Excel)
  ...
  /RCR_LU_FORM_CODE2/ROWS/{row_start}:{row_end}/{output}:
    get:
      ...
      x-api-path-slug: rcr-lu-form-code2rowsrow-startrow-endoutput-get
      parameters:
      - in: path
        name: output
        description: which format to output (JSON,XML,CSV,Excel)
  ...
  /RCR_LU_MANAGEMENT_METHOD/ROWS/{row_start}:{row_end}/{output}:
    get:
      ...
      x-api-path-slug: rcr-lu-management-methodrowsrow-startrow-endoutput-get
      parameters:
      - in: path
        name: output
        description: which format to output (JSON,XML,CSV,Excel)
  ...
  /RCR_LU_SOURCE_CODE2/ROWS/{row_start}:{row_end}/{output}:
    get:
      ...
      x-api-path-slug: rcr-lu-source-code2rowsrow-startrow-endoutput-get
      parameters:
      - in: path
        name: output
        description: which format to output (JSON,XML,CSV,Excel)
