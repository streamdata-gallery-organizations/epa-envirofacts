...
paths:
  ...
  /OGD_EF_GRANT_DTL_RPT/ROWS/{row_start}:{row_end}/{output}:
    get:
      ...
      x-api-path-slug: ogd-ef-grant-dtl-rptrowsrow-startrow-endoutput-get
      parameters:
      - in: path
        name: output
        description: which format to output (JSON,XML,CSV,Excel)
  ...
  /OGD_EF_GRANT_SUM_RPT/ROWS/{row_start}:{row_end}/{output}:
    get:
      ...
      x-api-path-slug: ogd-ef-grant-sum-rptrowsrow-startrow-endoutput-get
      parameters:
      - in: path
        name: output
        description: which format to output (JSON,XML,CSV,Excel)
  ...
  /OGD_STAT_AUTHORITY/ROWS/{row_start}:{row_end}/{output}:
    get:
      ...
      x-api-path-slug: ogd-stat-authorityrowsrow-startrow-endoutput-get
      parameters:
      - in: path
        name: output
        description: which format to output (JSON,XML,CSV,Excel)
